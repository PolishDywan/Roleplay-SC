...
public class MarkerSyncModule : ISingletonScript
{
    ...
    {
        if (!AltEntitySync.TryGetEntity(objectId, (ulong)AltV.Net.Data.EntityType.Object, out var entity))
        {
            return null;
        }
    ...
    public ServerMarker? GetMarker(IColShape colShape)
    {
        ...
        if (!AltEntitySync.TryGetEntity(_markers[colShape].Id, (ulong)AltV.Net.Data.EntityType.Object, out var entity))
        {
            return null;
        }

...
public class DiscordModule : ISingletonScript
{
    ...
    public bool CanJoin(ulong playerDiscordId)
    {
        ...
        {
            Console.WriteLine("CanJoin: _serverGuild is null");
            // Depending on your application's needs, you may choose to handle this differently.
            return false;
        }
        ...
        if (userClient == null)
        {
            Console.WriteLine($"CanJoin: User with Discord ID {playerDiscordId} not found.");
            // Again, return false or handle according to your application's needs.
            return false;
        }
    ...
    public string? GetAvatar(ulong playerDiscordId)
    {
        if (_serverGuild == null)
        {
            Console.WriteLine("GetAvatar: _serverGuild is null");
            return "";
        }

        if (!_serverGuild.IsConnected)
        {
            Console.WriteLine("GetAvatar: _serverGuild is not connected");
            return "";
        }
        ...
        if (userClient == null)
        {
            Console.WriteLine($"GetAvatar: Cannot find user with Discord ID {playerDiscordId}");
            return "";
        }

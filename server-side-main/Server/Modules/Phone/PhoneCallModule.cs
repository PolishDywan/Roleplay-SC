...
public class PhoneCallModule : ISingletonScript
{
    ...
    public async Task CallPhoneAsync(ServerPlayer player, string numberToCall, string callerNumber)
    {
        ...
        await AltAsync.Do(() =>
        {
            ...
            player.PhoneCallData = new PhoneCallData((ushort)playerToCall.Id, numberToCall, true);
            playerToCall.PhoneCallData = new PhoneCallData((ushort)player.Id, callerPhone.PhoneNumber, false);
        });
    }

    ...
    public Startup() : base(new ActionTickSchedulerFactory())
    {
        ...
        if (useLocal)
        {
            services.AddDbContextFactory<DatabaseContext>(options => options
                .UseMySql(Configuration.GetConnectionString("LocalDatabase"),
                    ServerVersion.AutoDetect(Configuration.GetConnectionString("LocalDatabase")))
        ...
        else
        {
            services.AddDbContextFactory<DatabaseContext>(options =>
                options.UseMySql(Configuration.GetConnectionString("LiveDatabase"),
                    ServerVersion.AutoDetect(Configuration.GetConnectionString("LiveDatabase"))));
        }

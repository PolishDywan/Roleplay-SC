...
></textarea>
            ...
            <div class='col-6'>
                <div class='form-check'>
                    <input v-model='form.hasPhone' class='form-check-input' type='checkbox' @change='send()' />
                    <label class='form-check-label'> Hat dein Charakter ein Handy? </label>
                </div>
                <div class='form-check'>
                    <input v-model='form.isRegistered' class='form-check-input' type='checkbox' @change='send()' />
                    <label class='form-check-label'> Ist dein Charakter im Registration Office gemeldet? </label>
                </div>
            </div>
            <div class='col-6'>
                <div class='form-check'>
                    <input v-model='form.hasDrivingLicense' :disabled='!form.isRegistered || form.profile.age < 21' class='form-check-input' type='checkbox' @change='send()' />
...
export default class CharacterFormular extends Vue {
    ...
    public form: CharacterFormInterface = {
        profile: {
    ...
    public onLessMoneyClicked(): void {
    ...
    public onMoreMoneyClicked(): void {
